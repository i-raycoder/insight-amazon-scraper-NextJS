export default function Main() {
  return (
    <section class="text-gray-600 body-font">
        ...
        <div class="ml-6 text-center">
          ...
          >
            <div class="flex text-lg">
              <span class="justify-center">Scrape</span>
            </div>
          </a>
          <a
          ...
          >
            <div class="flex text-lg">
              <span class="justify-center">Scrape Bulk</span>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="pt-40 pb-24 max-w-4xl mx-auto px-3 md:px-6">
        <div class="flex flex-wrap justify-center gap-8">
          <div class="flex flex-col items-center">
            <img class="w-16 mb-3" src="./rocket.png" alt="Fast" />
            <h3 class="text-xl font-extrabold uppercase text-white">
              Fast
            </h3>
          </div>
          <div class="flex flex-col items-center">
            <img class="w-16 mb-3" src="./secure.png" alt="Secure" />
            <h3 class="text-xl font-extrabold uppercase text-white">
              Secure
            </h3>
          </div>
          <div class="flex flex-col items-center">
            <img class="w-16 mb-3" src="./money.png" alt="Affordable" />
            <h3 class="text-xl font-extrabold uppercase text-white">
              Affordable
            </h3>
          </div>
          <div class="flex flex-col items-center">
            <img class="w-16 mb-3" src="./rely.png" alt="Reliable" />
            <h3 class="text-xl font-extrabold uppercase text-white">
              Reliable
            </h3>
          </div>
